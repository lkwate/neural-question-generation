...
class TransformerModel(nn.Module):
    ...
    def __init__(self, path_to_model, d_model=512, vocab_size=30522):
        ...
        self.embedding = Embedding(path_to_model, d_model)#.cuda(device)
    ...
    def forward(self, indexed_tokens_context=None, segments_ids_context=None, indexed_tokens_question=None,
                segments_ids_question=None, memory=None, indexed_tokens=None, segments_ids=None, decode=False):
